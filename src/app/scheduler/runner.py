...
MODULE_COMMANDS: list[tuple[str, list[str]]] = [
    ...
    (
        "research.summary",
        [sys.executable, "-m", "app.research", "summary"],
    ),
    (
        "congress.summary",
    ...
    (
        "polymarket.summary",
        [sys.executable, "-m", "app.polymarket", "summary"],
    ),
    (
        "risk.dashboard",
        [sys.executable, "-m", "app.risk", "dashboard"],
    ),
    (
        "portfolio.dashboard",
        [sys.executable, "-m", "app.portfolio", "dashboard"],
    ),
    (
        "portfolio.snapshot",
        [sys.executable, "-m", "app.portfolio", "snapshot"],
    ),
    (
        "quant.summary",
        [sys.executable, "-m", "app.quant", "summary"],
    ),
    (
        "history.weights",
